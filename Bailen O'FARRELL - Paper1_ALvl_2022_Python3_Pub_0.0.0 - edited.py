        ...
        if len(self.__Locks) > 0:
            ...
            while not self.__GameOver:
                ...
                while not self.__LockSolved and not self.__GameOver:
                    ...
                    #edit
                    print("there are:",self.__Deck.GetNumberOfCards(),"cards in the deck")
                    #edit
                    print(self.__Hand.GetCardDisplay())
                    MenuChoice = self.__GetChoice(self.__CurrentLock.GetPeekState())
                    if MenuChoice == "D":
...
class Lock():
    def __init__(self):
        ...
        #edit
    #edit
    def GetPeekState(self):
        return self._PeekUsed

    def SetPeekUsed(self):
        self._PeekUsed = True
        
    def SetPeekNotUsed(self):
        self._PeekUsed = False
    #edit
